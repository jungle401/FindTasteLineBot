...
from linebot.models import MessageEvent, TextMessage, TextSendMessage, TemplateSendMessage, ButtonsTemplate, LocationAction, LocationMessage
...
def handle_postback(event):
    ...
    #     get_location(event)
    #     return
    # # target_type is the type of locations for google map to search
    # # e.g.: restaurant, cafe, convenience_store
